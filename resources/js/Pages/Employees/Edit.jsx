...
export default function Edit({ employee, positions }) {
    const { data, setData, post, processing, errors } = useForm({
        _method: 'put',
        name: employee.name || '',
        nik: employee.nik || '',
        nik_kependudukan: employee.nik_kependudukan || '',
        position_ids: employee.position_ids || [],
        ...
        is_certified: employee.is_certified == 1,
    ...
    const submit = (e) => {
        e.preventDefault();
        // Use post for file uploads with spoofed method put
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <h2 className="text-3xl font-extrabold text-slate-900 tracking-tight">
                            Edit <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">Pegawai</span>
                        </h2>
                    </div>
                </div>
            }
            ...
            <div className="pb-8 max-w-5xl mx-auto space-y-6">
                ...
                <form onSubmit={submit}>
                    ...
                    <div className="mt-6 flex items-center justify-end space-x-4">
                        ...
                        >
                            <Save className="w-5 h-5 mr-2" /> Perbarui Pegawai
                        </Button>
                    </div>
                </form>
            </div>
